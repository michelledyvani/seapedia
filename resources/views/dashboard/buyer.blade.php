...
<div class="max-w-7xl mx-auto px-4 py-8">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-md hover:-translate-y-1 transition-all duration-200">
            ...
            <p class="text-3xl font-extrabold text-blue-600 mb-4">Rp {{ number_format($wallet->balance,0,',','.') }}</p>
            <a href="{{ route('buyer.wallet') }}" class="block w-full text-center py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg transition-colors duration-200">Top Up Saldo</a>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-md hover:-translate-y-1 transition-all duration-200">
            ...
            <p class="text-3xl font-extrabold text-gray-900 mb-1">{{ $orders }}</p>
            <p class="text-sm text-gray-400 mb-4">transaksi</p>
            <a href="{{ route('buyer.orders') }}" class="block w-full text-center py-2.5 border border-gray-200 text-gray-700 text-sm font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200">Riwayat Pesanan</a>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-md hover:-translate-y-1 transition-all duration-200">
            ...
            <p class="text-3xl font-extrabold text-gray-900 mb-1">{{ Auth::user()->addresses()->count() }}</p>
            <p class="text-sm text-gray-400 mb-4">lokasi</p>
            <a href="{{ route('buyer.addresses') }}" class="block w-full text-center py-2.5 border border-gray-200 text-gray-700 text-sm font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200">Kelola Alamat</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        ...
        <div class="flex gap-4 flex-wrap">
            <a href="{{ route('products.index') }}" class="inline-flex items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-full transition-colors duration-200">
                Mulai Belanja
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
            </a>
            <a href="{{ route('buyer.cart') }}" class="inline-flex items-center gap-2 px-6 py-2.5 border border-gray-200 text-gray-700 text-sm font-semibold rounded-full hover:bg-gray-50 transition-colors duration-200">
